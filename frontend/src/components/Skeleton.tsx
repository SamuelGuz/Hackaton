...
export function SkeletonCard() {
  return (
    <div className="relative isolate overflow-hidden rounded-xl border border-slate-800/90 co-surface-tile-bg p-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.04)]">
